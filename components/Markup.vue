<template>
  <v-card
    ...
    outlined
  >
    <prism v-if="$slots.default || code" :language="language" :code="code" :inline="inline">
      <slot />
    </prism>

    <div v-if="!hideCopy" class="v-markup__copy">
      <v-icon title="Copy code" aria-label="Copy code" @click="copyMarkup">mdi-content-copy</v-icon>
